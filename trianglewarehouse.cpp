...
/*
 *  Konstruktor obiektów reprezentujących magazynyu w kształtach trójkątów.
 *  Trójkąt opisany jest przez dwie proste, zwierające jego ramiona i podstawę.
 *  Równania prostych zawierające ramiona trójkąta:
...
*/
TriangleWarehouse::TriangleWarehouse(double leftLegA, double rightLegA, double rightLegB, double hallwayWidth) :
 ...
 */
TriangleWarehouse TriangleWarehouse::crossover(TriangleWarehouse secondParent)
{
    ...
    //merging
    TriangleWarehouse child(leftLegA, rightLegA, rightLegB, hallwayWidth); //tworzymy nasze dziecko
 ...
 */
void TriangleWarehouse::fillWithWares()
{
    ...
    double warehouseHeight = leftLegA * rightLegB / ( leftLegA - rightLegA ); // wysokość magazynu
